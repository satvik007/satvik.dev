  ...
  return (
    <MainLayout>
      ...
      <div className='bg-prism'>
        <article className='mx-auto flex w-full max-w-3xl flex-col items-start justify-center bg-white px-16 pt-6 pb-16 lg:rounded-3xl lg:border-2 lg:border-amber-500'>
          ...
          <div className='dark:prose-dark prose mt-4 w-full max-w-none'>{children}</div>
